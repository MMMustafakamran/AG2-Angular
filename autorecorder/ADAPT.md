...
integration to another. In this repo it records **AG2 (Python) + Angular**. The
target might be `ms-agent-dotnet`, `agno`, `langgraph`, a React frontend, or
anything else CopilotKit documents.
...
`videoPrefix` **must** identify both sides of the integration — `AG2-angular`,
